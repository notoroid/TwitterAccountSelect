...
{
 	NSString* repositoryFileName = @"settings.dat";
	NSString* repositoryTwitterIdentifier = @"TwitterIdentifier";
	...
	if( update == YES ){ // 更新
		if ([fileManager fileExistsAtPath:dataFilepath]) {
			...
			_twitterIdentifier = [decoder decodeObjectForKey:repositoryTwitterIdentifier];
		...
		[encoder encodeObject:_twitterIdentifier forKey:repositoryTwitterIdentifier];
